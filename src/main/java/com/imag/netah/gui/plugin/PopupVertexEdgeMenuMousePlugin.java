...
public class PopupVertexEdgeMenuMousePlugin<V, E> extends AbstractPopupGraphMousePlugin {
    ...
    private JPopupMenu edgePopup, vertexPopup, deviceChoicePopup;
    ...
    public PopupVertexEdgeMenuMousePlugin() {
        ...
        //this(MouseEvent.BUTTON3_MASK | MouseEvent.BUTTON1_MASK | MouseEvent.SHIFT_MASK);
        deviceChoicePopup = new MyMouseMenus.DeviceChoiceMenu();      
    }
        ...
        if (pickSupport != null) {
            ...
            if (v != null) {
                ...
                if (edge != null) {
                    ...
                    //System.out.println("Nothing selected, display the Device type checker popup");
                    deviceChoicePopup.show(vv, e.getX(), e.getY());
                }
            }
        }
